        ...
        <AuthenticatedLayout auth={auth}>
            ...
            <div className="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
                <form onSubmit={submit}>
                    ...
                    <input type="file" class="relative m-0 pt-2 pb-2 block w-full min-w-0 flex-auto rounded border border-solid border-neutral-200 bg-clip-padding px-3 py-[0.32rem] text-base text-neutral-700 transition duration-300 ease-in-out file:-mx-3 file:-my-[0.32rem] file:overflow-hidden file:rounded-none file:border-0 file:border-solid file:border-inherit file:bg-gray-300 file:rounded file:px-3 file:py-[0.32rem] file:text-gray-800 hover:file:text-gray-100 file:transition file:duration-150 file:ease-in-out file:[border-inline-end-width:1px] file:[margin-inline-end:0.75rem] hover:file:bg-gray-600 focus:border-primary focus:text-gray-100 focus:shadow-te-primary focus:outline-none "
                ...
                <div className="mt-6 bg-gray-300 shadow-sm rounded-lg divide-y-4">
